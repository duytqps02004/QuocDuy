...
Public Class frmquanlisanpham
    ...
    End Sub
    Private Sub Button4_Click(sender As Object, e As EventArgs) Handles btnThoat.Click
        Me.Close()

    End Sub

    Private Sub frmquanlisanpham_Load(sender As Object, e As EventArgs) Handles MyBase.Load

    End Sub

    Private Sub TextBox3_TextChanged(sender As Object, e As EventArgs) Handles txtDonGia.TextChanged
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles btnThem.Click
        ...
        Dim Query2 As String = "insert into SanPham values (@MaSanPham,@TenSanPham,@DonGia,@SoLuong,@ChiTietSanPham)"
        ...
        Try
            ...
            ExecuteQuery1.Parameters.AddWithValue("@MaSanPham", txtMasanpham.Text)
            ExecuteQuery1.Parameters.AddWithValue("@TenSanPham", txtTensanpham.Text)
            ExecuteQuery1.Parameters.AddWithValue("@DonGia", txtDonGia.Text)
            ExecuteQuery1.Parameters.AddWithValue("@SoLuong", txtSoLuong.Text)
            ExecuteQuery1.Parameters.AddWithValue("@ChiTietSanPham", txtChitietsanpham.Text)
    ...
    Private Sub btnSua_Click(sender As Object, e As EventArgs) Handles btnSua.Click
        ...
        ketnoi1.Open()
        Dim Stradd1 As String = "Update SanPham Set TenSanPham = @TenSanPham, DonGia = @DonGia, SoLuong = @SoLuong, ChiTietSanPham = @ChiTietSanPham where MaSanPham = @MaSanPham"
        ...
        Try
            ...
            com.Parameters.AddWithValue("@ChiTietSanPham", txtChitietsanpham.Text)
            com.ExecuteNonQuery()
            ketnoi1.Close()
    ...
    Private Sub btnXoa_Click(sender As Object, e As EventArgs) Handles btnXoa.Click
        ...
        ketnoi.Open()
        Dim xoadl As String = "Delete from SanPham Where MaSanPham = @MaSanPham"
        Dim lenh As New SqlCommand(xoadl, ketnoi)
        Try
            lenh.Parameters.AddWithValue("@MaSanPham", txtMasanpham.Text)
    ...
    Private Sub DataGridView1_CellContentClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        txtSoLuong.Text = DataGridView1.Item(2, index).Value
